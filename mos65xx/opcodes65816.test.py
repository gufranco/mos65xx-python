...
class RenderTest(unittest.TestCase):
    def test_a_mode_the_renderer_does_not_know_is_refused(self):
...
class DisassembleTest(unittest.TestCase):
    ...
    def test_a_listing_runs_on_past_a_return_when_not_asked(self):
    ...
    def test_a_listing_stops_once_it_holds_the_number_of_steps_asked_for(self):
