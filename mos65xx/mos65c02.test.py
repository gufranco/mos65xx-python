...
def machine(program, at=0x8000, table=opcodes65c02.CMOS, **registers):
...
class FixedBugTest(unittest.TestCase):
    def test_a_jump_through_a_pointer_at_a_page_end_reads_the_right_high_byte(self):
    ...
    def test_a_break_clears_the_decimal_flag(self):
    ...
    def test_a_decimal_add_sets_the_sign_from_the_decimal_result(self):
    ...
    def test_a_decimal_add_that_reaches_zero_says_so(self):
    ...
    def test_a_decimal_subtract_of_an_operand_that_is_not_a_decimal_number(self):
    ...
    def test_a_decimal_subtract_sets_the_sign_from_the_decimal_result(self):
...
class DecimalEdgeTest(unittest.TestCase):
    def test_a_decimal_add_whose_low_digit_stays_a_digit_does_not_correct_it(self):
    ...
    def test_a_decimal_subtract_that_stays_above_zero_takes_no_sixty(self):
    ...
    def test_a_decimal_subtract_whose_low_digit_covers_it_takes_no_six(self):
...
class NewInstructionTest(unittest.TestCase):
    def test_a_branch_that_always_takes_always_takes(self):
    ...
    def test_a_store_of_zero_stores_zero(self):
    ...
    def test_a_test_and_set_sets_the_bits_and_reports_the_old_ones(self):
    ...
    def test_a_test_and_clear_clears_them(self):
    ...
    def test_the_index_registers_can_be_pushed_and_pulled(self):
    ...
    def test_pulling_them_in_the_other_order_swaps_them(self):
    ...
    def test_the_accumulator_can_be_incremented_on_its_own(self):
    ...
    def test_a_pointer_with_no_index_reaches_where_it_points(self):
    ...
    def test_an_indexed_jump_through_a_pointer_goes_where_the_index_lands(self):
    ...
    def test_an_immediate_bit_test_only_reports_whether_anything_matched(self):
    ...
    def test_a_bit_test_against_memory_still_reports_its_two_top_bits(self):
    ...
    def test_a_no_operation_of_stated_length_consumes_exactly_that(self):
...
class RockwellTest(unittest.TestCase):
    def test_a_bit_can_be_cleared_in_the_first_page(self):
    ...
    def test_a_bit_can_be_set_there(self):
    ...
    def test_each_of_the_eight_reaches_its_own_bit(self):
        for bit in range(8):
    ...
    def test_a_branch_on_a_clear_bit_takes_when_it_is_clear(self):
    ...
    def test_a_branch_on_a_set_bit_is_the_other_way_round(self):
    ...
    def test_the_base_part_treats_the_same_byte_as_doing_nothing(self):
...
class WdcTest(unittest.TestCase):
    def test_the_processor_can_be_stopped(self):
    ...
    def test_the_processor_can_be_made_to_wait(self):
    ...
    def test_waiting_is_not_stopping(self):
        cpu, _ = machine([0xCB], table=opcodes65c02.WDC)
    ...
    def test_the_earlier_parts_do_nothing_with_the_same_bytes(self):
...
class EveryOpcodeTest(unittest.TestCase):
    def test_every_opcode_of_every_part_runs(self):
    ...
    def test_every_opcode_of_every_part_has_an_implementation(self):
        for name, table in opcodes65c02.TABLES.items():
            missing = [
